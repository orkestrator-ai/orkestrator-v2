...
import { closeGitHubIssue, getGitHubIssue, listGitHubIssueComments, listGitHubIssues, postGitHubIssueComment, sanitizeGitHubError, updateGitHubIssue, updateGitHubIssueComment, updateGitHubIssueStatus } from "./commands-dependencies.js";
import { asString, requireGitHubProject, asGitHubIssueStatus, withGitHubCompletionCommentLock, asNumber } from "./commands-helpers.js";
