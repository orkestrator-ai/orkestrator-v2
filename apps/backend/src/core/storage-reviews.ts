...
const {
  ...
  MAX_PANE_LAYOUT_ROOT_BYTES,
  MAX_PANE_LAYOUT_SELECTION_INTENT_BYTES,
  MAX_PANE_LAYOUT_SELECTION_ENTRIES,
  ...
  isPersistedPromptQueueClaim,
  isPersistedPromptQueue,
  CLAUDE_TMUX_QUEUE_PREFIX,
  promptQueueKeyMatchesEnvironment,
  ...
  validateCodexMaxConcurrentThreads,
  migrateLegacyReviewInstruction,
  validateConfigReviewInstruction,
  validateGlobalReviewInstruction,
  sanitizePersistedReviewInstruction,
  ...
  parseOpenCodeModelCatalogSnapshot,
...
void [fs, path, createHash, randomBytes, randomUUID, aggregateAgentActivityState, AGENT_ACTIVITY_MAX_FUTURE_SKEW_MS, AGENT_ACTIVITY_SOURCES, AGENT_ACTIVITY_STATES, FRONTEND_AGENT_ACTIVITY_LEASE_MS, isAgentActivityTimestamp, parseUsableAgentActivityTime, AGENT_INTERACTION_JOURNAL_VERSION, INTERACTIVE_AGENT_INTERACTION_POLICY, UNATTENDED_AGENT_INTERACTION_POLICY, isAgentInteractionPolicy, isAgentInteractionResolutionJournal, pruneAgentInteractionResolutionJournal, parseStoredDesktopConnections, isFeaturePlanningRecord, isTerminalFeaturePlanningPhase, parseClaudeTmuxStateKey, getReviewInstructionValidationError, parseReviewInstruction, LEGACY_ENABLED_AGENT_PLATFORMS, firstEnabledAgentPlatform, isAgentPlatform, normalizeAgentPlatforms, DEFAULT_CLAUDE_MODE, PANE_LAYOUT_VERSION, paneLayoutRevisionConflictMessage, isMultiReviewTerminalPhase, isMultiReviewWorkflow, mergePersistedPaneLayouts, isTabTeardownKind, RESOURCE_MANIFEST_KINDS, DEFAULT_OPENCODE_MODEL_PROVIDERS, migrateOpenCodeModelProviders, normalizeOpenCodeModelProviders, DEFAULT_CODEX_MAX_CONCURRENT_THREADS, isValidCodexMaxConcurrentThreads, MAX_CODEX_CONCURRENT_THREADS, resolveCodexMaxConcurrentThreads, NATIVE_AGENT_SESSION_VERSION, MAX_FRONTEND_AGENT_ACTIVITY_OBSERVERS, MAX_PANE_LAYOUT_ROOT_BYTES, MAX_PANE_LAYOUT_SELECTION_INTENT_BYTES, MAX_PANE_LAYOUT_SELECTION_ENTRIES, PROMPT_QUEUE_CLAIM_LEASE_MS, MAX_PROMPT_QUEUE_SOURCE_KEY_BYTES, MAX_PROMPT_QUEUE_SOURCE_MESSAGE_ID_BYTES, assertPaneLayoutRootWithinBounds, assertPaneLayoutSelectionIntentWithinBounds, assertPaneLayoutGeneration, paneLayoutLeaves, environmentIsReadyForSetupHandoff, selectedTabIsSetupHandoffSource, suppressLateSetupTabAdditions, resizeKanbanImage, MAX_JSON_BACKUPS, MAX_PERSISTED_NATIVE_AGENT_PENDING_DISPATCH_BYTES, MAX_SESSIONS_PER_ENVIRONMENT, DEFAULT_ALLOWED_DOMAINS, nowIso, defaultEnvironmentName, isRecord, isInitialPromptImageAttachment, isStartupAgentSession, isOneOf, isNonBlankString, readAgentActivitySources, frontendAgentActivityObserverKey, agentActivityStructureFingerprint, readFrontendAgentActivityObservers, aggregateEnvironmentAgentActivity, nextAgentActivityTimestamp, isPositiveInteger, isNonNegativeInteger, isCanonicalUuid, isPortNumber, isPortMapping, isPersistedLoopedReviewWorkflow, isPersistedMultiReviewWorkflow, isPersistedPromptQueueClaim, isPersistedPromptQueue, CLAUDE_TMUX_QUEUE_PREFIX, promptQueueKeyMatchesEnvironment, assertPromptQueueKeyOwner, isPersistedNativeAgentSession, migratePersistedNativeAgentSession, resolveNativeAgentInteractionMetadata, isPersistedComposeDraft, isPersistedFileDraft, isPersistedAgentHandoff, isPersistedBuildPipeline, activeGitHubBuildReservation, activeBuildAdmissionKey, isClaudeModelCatalogSnapshot, CODEX_REASONING_EFFORTS, normalizeClaudeModelCatalogEntries, normalizeCodexModelCatalogEntries, normalizeAcpModelCatalogEntries, parsePersistedAgentModelCatalogCache, validateCodexMaxConcurrentThreads, migrateLegacyReviewInstruction, validateConfigReviewInstruction, validateGlobalReviewInstruction, sanitizePersistedReviewInstruction, storedOpenCodeModelIds, normalizePersistedConfig, slugify, sanitizeEnvironmentName, sanitizeBranchName, extractRepoName, defaultConfig, defaultRepositoryConfig, createProject, createEnvironment, createSessionObject, exists, isMissingFileError, normalizeOpenCodeModelCatalogEntries, normalizeOpenCodeModelCatalogProjectId, parseOpenCodeModelCatalogSnapshot, parseOpenCodeModelCatalogStore, getUnscopedLegacyOpenCodeModelCatalog, FeaturePlanningFenceError, PendingNativeAgentDispatchError];
