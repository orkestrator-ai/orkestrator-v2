...
| 07 | [MCP inventory and management](07-mcp-inventory-and-management.md) | ⬜ | 02, 04 | Normalized MCP server model with status, tools and actions (reconnect, toggle, sign in), served by the backend and rendered by one generic panel. |
