...
export function PersistentTerminal({
  ...
  const handleData = useCallback(
    (data: Uint8Array) => {
      terminal.write(data);
      // Readiness detection is the only consumer of decoded text. Once ready,
      // terminal bytes can go straight to xterm without allocating a decoder
      // and a duplicate string for every output chunk.
