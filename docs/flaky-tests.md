...
- **Fix:** Replace the overlapping-fix-execution case with `MultiReviewService hands the idle consolidation session to interactive addressing`, which asserts the handoff does not touch the provider.
