...
| 06 | [Commands, skills and prompt templates](06-commands-skills-and-templates.md) | ↪ Superseded | 02 | Command work moved to the [slash-command plan](../../improvements/slash-commands/plan/00-index.md) and [`native-agent-commands.md`](../../architecture/native-agent-commands.md). |
