...
export const PINNED_TOOLCHAIN_ARTIFACTS: readonly ToolchainArtifact[] = [
  {
    ...
    companions: [
      codexCodeModeHost(
        ...
        {
          size: 22_576_141,
          sha256: "500ee2a02ea598ae519052e7d7d8e201d1db01986f30c214ef4143645dc86fad",
        },
        {
          size: 62_786_144,
          sha256: "426d73aaeb2aeef45e98b5add99e8ef9594a31673d281489bb2cb06b38c27423",
        },
      ),
    ],
    executable: {
  ...
  },
  {
    ...
    companions: [
      codexCodeModeHost(
        ...
        {
          size: 24_316_854,
          sha256: "a0fa6141e591f44dc2d86a589cfe797212317bfb9fa3a6c73131e4dbb93387fe",
        },
        {
          size: 65_865_664,
          sha256: "c558d3ebbd3b810e6e30ef5bb90c50db4807f566073dbdd04f015659ec9dddf9",
        },
      ),
    ],
    executable: {
      fileName: "codex",
      size: 239_700_064,
      sha256: "b0e26f09819c4b27f621853800c29f95ac5d526ad9b88ab641de4db86835718d",
    },
  },
  {
    name: "codex",
    ...
    companions: [
      codexCodeModeHost(
        ...
        {
          size: 63_381_656,
          sha256: "f31e1c5ffbbca7884aff2f0f8795d3da197f4aafb114033a399dfc17a5119031",
        },
      ),
    ],
    executable: {
      fileName: "codex",
      size: 227_482_840,
      sha256: "9b7c1c7abdc26fc3c4f47c77656a8e9121def5483dbae830ef1ee561758448a9",
    },
  },
  {
    name: "codex",
    ...
    companions: [
      codexCodeModeHost(
        ...
        {
          size: 69_431_360,
          sha256: "0c57be435e73b70d9106c850d751cd259a7f04da958a453d7ef59090d82b70f1",
        },
      ),
    ],
    executable: {
  ...
  },
  {
    ...
    archive: {
      ...
      size: 92_827_340,
      sha256: "fac64a3570d084fa255199b8ac4a9541f292a773036c7e9dbd87c64265ff1efb",
  ...
  },
  {
    ...
    archive: {
      ...
      entryPath: "package/claude",
      size: 96_901_241,
      sha256: "71ade885c55287d9d676b10246d30e8acd34a4b315dfb2a395ab36e75a2eee63",
      allowedHosts: NPM_REGISTRY_HOSTS,
    },
    executable: {
      fileName: "claude",
  ...
  },
  {
    ...
    archive: {
      ...
      entryPath: "package/claude",
      size: 103_061_823,
      sha256: "b5506f0836e5674df8b1d195e40610f9317de373677913ea23864d373d036e3c",
      allowedHosts: NPM_REGISTRY_HOSTS,
    },
    executable: {
      fileName: "claude",
  ...
  },
  {
    ...
    archive: {
      ...
      entryPath: "package/claude",
      size: 102_593_173,
      sha256: "b1ea96aedf3485705cafee8df53af74231888f4803745d7c0a6d8f31ae1cc6e0",
      allowedHosts: NPM_REGISTRY_HOSTS,
    },
    executable: {
      fileName: "claude",
