...
/**
 * Close tool cards still pending after the run that owned them has ended.
 *
 ...
 * never produced a final message. ACP already fails these on restart; do the
 * same here the moment the parent run is terminal, and again on restore for
 * a process that died mid-turn.
 *
 * This is not a claim that the tool failed in the workspace. It is a claim
 * that this bridge will never see a result for it.
 */
