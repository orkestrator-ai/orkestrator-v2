...
export const mockRemoveProject = mock<(projectId: string) => Promise<void>>(() =>
  Promise.resolve(),
);
export const mockValidateGitUrl = mock<(url: string) => Promise<boolean>>(() =>
  Promise.resolve(true),
);

export const mockGetEnvironments = mock<(projectId: string) => Promise<Environment[]>>(() =>
  Promise.resolve([]),
);
export const mockGetEnvironment = mock<(environmentId: string) => Promise<Environment | null>>(() =>
  Promise.resolve(null),
);
export const mockCreateEnvironment = mock<(projectId: string) => Promise<Environment>>(
  (projectId: string) => Promise.resolve(createMockEnvironment({ projectId })),
);
export const mockDeleteEnvironment = mock<(environmentId: string) => Promise<void>>(() =>
  Promise.resolve(),
);
export const mockStartEnvironment = mock<(environmentId: string) => Promise<void>>(() =>
  Promise.resolve(),
);
export const mockStopEnvironment = mock<(environmentId: string) => Promise<void>>(() =>
  Promise.resolve(),
);
...
export const mockCreateTerminalSession = mock<
  (containerId: string, cols: number, rows: number) => Promise<string>
>(() => Promise.resolve("mock-session-id"));
export const mockStartTerminalSession = mock<(sessionId: string) => Promise<void>>(() =>
  Promise.resolve(),
);
export const mockDetachTerminal = mock<(sessionId: string) => Promise<void>>(() =>
  Promise.resolve(),
);
export const mockWriteTerminal = mock<(sessionId: string, data: string) => Promise<void>>(() =>
  Promise.resolve(),
);
export const mockResizeTerminal = mock<
...
export const mockClearEnvironmentPr = mock<(environmentId: string) => Promise<void>>(() =>
  Promise.resolve(),
);
export const mockSetEnvironmentPr = mock<
  (environmentId: string, prUrl: string) => Promise<Environment>
